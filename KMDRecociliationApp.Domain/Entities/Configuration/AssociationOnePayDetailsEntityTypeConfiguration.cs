...
{
     public class AssociationOnePayDetailsEntityTypeConfiguration
       : IEntityTypeConfiguration<AssociationOnePayDetails>
    {

        public void Configure(EntityTypeBuilder<AssociationOnePayDetails> builder)
        {

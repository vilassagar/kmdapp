...
namespace KMDRecociliationApp.Domain.Entities.Configuration
{
    ...
    public class PaymentModeGatewayEntityTypeConfiguration
       : IEntityTypeConfiguration<PaymentModeGateway>
    {

        public void Configure(EntityTypeBuilder<PaymentModeGateway> builder)
        {

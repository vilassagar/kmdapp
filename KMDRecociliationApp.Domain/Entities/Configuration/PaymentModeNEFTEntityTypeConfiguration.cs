...
namespace KMDRecociliationApp.Domain.Entities.Configuration
{
    ...
    public class PaymentModeNEFTEntityTypeConfiguration
       : IEntityTypeConfiguration<PaymentModeNEFT>
    {

        public void Configure(EntityTypeBuilder<PaymentModeNEFT> builder)
        {

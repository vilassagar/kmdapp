...
namespace KMDRecociliationApp.Domain.Entities.Configuration
{
    ...
    public class BeneficiaryPersonEntityTypeConfiguration
       : IEntityTypeConfiguration<BeneficiaryPerson>
    {

        public void Configure(EntityTypeBuilder<BeneficiaryPerson> builder)
        {

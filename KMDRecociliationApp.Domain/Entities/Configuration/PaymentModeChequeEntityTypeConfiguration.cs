...
namespace KMDRecociliationApp.Domain.Entities.Configuration
{
    ...
    public class PaymentModeChequeEntityTypeConfiguration
       : IEntityTypeConfiguration<PaymentModeCheque>
    {

        public void Configure(EntityTypeBuilder<PaymentModeCheque> builder)
        {

...
{
    public class BeneficiaryDetailsEntityTypeConfiguration
       : IEntityTypeConfiguration<BeneficiaryDetails>
    {

        public void Configure(EntityTypeBuilder<BeneficiaryDetails> builder)
        {

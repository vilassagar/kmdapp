...
namespace KMDRecociliationApp.Domain.Entities.Configuration
{
    ...
    public class ExecuteCampaignEntityTypeConfiguration
       : IEntityTypeConfiguration<ExecuteCampaign>
    {

        public void Configure(EntityTypeBuilder<ExecuteCampaign> builder)
        {

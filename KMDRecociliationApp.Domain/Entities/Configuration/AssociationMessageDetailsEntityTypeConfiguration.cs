...
namespace KMDRecociliationApp.Domain.Entities.Configuration
{
     ...
     public class AssociationMessageDetailsEntityTypeConfiguration
       : IEntityTypeConfiguration<AssociationMessageDetails>
    {

        public void Configure(EntityTypeBuilder<AssociationMessageDetails> builder)
        {

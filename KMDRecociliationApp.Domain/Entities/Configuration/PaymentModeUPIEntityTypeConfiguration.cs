...
namespace KMDRecociliationApp.Domain.Entities.Configuration
{
    ...
    public class PaymentModeUPIEntityTypeConfiguration
       : IEntityTypeConfiguration<PaymentModeUPI>
    {

        public void Configure(EntityTypeBuilder<PaymentModeUPI> builder)
        {

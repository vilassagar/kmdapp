...
namespace KMDRecociliationApp.Domain.Entities.Configuration
{
    ...
    public class PolicyProductDetailsEntityTypeConfiguration
       : IEntityTypeConfiguration<PolicyProductDetails>
    {

        public void Configure(EntityTypeBuilder<PolicyProductDetails> builder)
        {
